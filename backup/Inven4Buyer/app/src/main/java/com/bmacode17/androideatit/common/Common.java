...
import com.bmacode17.androideatit.remotes.GoogleRetrofitClient;
...
public class Common {
    ...
    public static GoogleAPIService getGoogleMapAPIService(){
        ...
        return GoogleRetrofitClient.getGoogleClient(GOOGLE_API_URL).create(GoogleAPIService.class);
    }
