...
import com.harshit.androideatit.Model.Category;
import com.harshit.androideatit.Model.Order;
import com.harshit.androideatit.Model.Token;
import com.harshit.androideatit.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //make sure you move this function after database.getInstance
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull MenuViewHolder viewHolder, int position, @NonNull Category model) {
                ...
                Picasso.with(getBaseContext()).load(model.getName())
    ...
    private void updateToken(String token) {
        ...
        Token data = new Token(token, false); // false because this token is send from client app
    ...
    private void showChangedPasswordDialog() {
        ...
        alertDialog.setMessage("Please fill an information");
        ...
        alertDialog.setPositiveButton("CHANGE", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //change password here0

                //for using spots dialog, use alert dialog from android.app, not from v7 like above alert dialog
