package com.harshit.androideatitserver;
...
import com.harshit.androideatitserver.Model.Category;
import com.harshit.androideatitserver.Model.Food;
import com.harshit.androideatitserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if(newFood != null)
                {
                    ...
                    Snackbar.make(rootLayout,"New Category "+newFood.getImage()+" was added",Snackbar.LENGTH_SHORT)
                            .show();
                }
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                  ...
                  //update information
                    ...
                    foodList.child(key).setValue(item);  //just fix here
                    Snackbar.make(rootLayout," Food "+item.getImage()+" was edited",Snackbar.LENGTH_SHORT)
                            .show();
