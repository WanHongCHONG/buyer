...
//                .setSmallIcon(R.drawable.notificationlogosmall)
//                .setLargeIcon(BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.ecommercelogo_round))
